...
class Image:
    def __init__(self, x_pixels=0, y_pixels=0, num_channels=0, filename=''):
        ...
        self.input_path = 'c:/Repositories/beginner-python-projects/PY_PHOTOSHOP/input/'
        self.output_path = 'c:/Repositories/beginner-python-projects/PY_PHOTOSHOP/output/'
